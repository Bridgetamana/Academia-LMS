  ...
  const featuresList = [
    {
      ...
      description:
        'Organize lessons, modules, and resources cleanly. Let your content speak for itself without UI clutter.',
      icon: (
        <FontAwesomeIcon
    ...
    },
    {
      ...
      description:
        'Set cohorts, due dates, and live sessions in one unified calendar integrated directly into the student experience.',
      icon: (
        <FontAwesomeIcon
          icon={faCalendarDays}
          className='text-xl text-text-main'
    ...
    },
    {
      ...
      description:
        'Track completion rates and engagement metrics to understand exactly where students drop off.',
      icon: (
        <FontAwesomeIcon icon={faChartBar} className='text-xl text-text-main' />
      ),
    },
    {
      title: 'Built for Educators',
      description:
        'From individual creators to full-scale bootcamps, the platform scales gracefully to fit your operational needs.',
      icon: (
        <FontAwesomeIcon
          icon={faUserGraduate}
          className='text-xl text-text-main'
      ...
      <div className='mx-auto max-w-6xl px-4 sm:px-6 relative z-10 flex flex-col items-center'>
        ...
        >
          ...
          <p className='text-text-muted text-lg font-sans'>
            A comprehensive toolkit designed to help you build, manage, and
            scale your educational product.
          </p>
        </motion.div>
